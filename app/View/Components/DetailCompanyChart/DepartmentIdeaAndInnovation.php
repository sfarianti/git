...
class DepartmentIdeaAndInnovation extends Component
{
    public $companyId;
    ...
    public function __construct($companyId)
    {
        ...
        $this->departmentData = $this->getDepartmentData($getCompanyCode->company_code);
    }
    ...
    {
        return view('components.detail-company-chart.department-idea-and-innovation');
    }

    public function getDepartmentData($companyCode)
    {
