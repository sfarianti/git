...
<body>
    ...
    @elseif($status == 'rejected benefit by facilitator')
        <p>Maaf, benefit Anda belum disetujui oleh Fasilitator sehingga anda masih belum dapat lanjut ke tahap berikutnya.</p>
    @elseif($status == 'accepted benefit by general manager')
        <p>Selamat, benefit Anda telah disetujui oleh General Manager (GM). Silakan untuk lanjut ke tahap berikutnya.</p>
    @elseif($status == 'rejected benefit by general manager')
        <p>Maaf, benefit Anda belum disetujui oleh General Manager (GM) sehingga anda masih belum dapat lanjut ke tahap berikutnya.</p>
    @endif
