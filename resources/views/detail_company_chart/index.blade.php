    ...
    <div class="container">
        <div class="row mt-2">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                ...
                <button type="button" class="btn btn-primary btn-sm mt-2" data-bs-toggle="modal" data-bs-target="#yearFilterModal">
                    Filter Tahun
                </button>
            </div>
        </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <img src="{{ $company->logo_url }}" alt="Logo {{ $company->company_name }}" class="img-fluid mb-3"
                                style="max-height: 100px;">
                            <div class="chart-placeholder" style="height: 200px;">
                                <x-detail-company-chart.innovator-chart
