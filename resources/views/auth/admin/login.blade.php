    ...
    <div class="container">
        ...
        <div class="form ">
            <div class="login tw-bg-gradient-to-r tw-from-red-700 tw-to-red-200 tw-drop-shadow-lg">
                <p id="login-text">Login Admin</p>
                <form id="login-form" method="post" action="{{ route('admin.store')}}">
                    @csrf
        ...
        <p id="copyright">Copyright 2024 All rights reserved. PT Semen Indonesia</p>
    </div>
@endsection
