            ...
            <div class="col-lg-9">
                <div class="card card-header-actions mb-4">
                    <div class="card-header">
                        Tabel Kategori
                        <button class="btn btn-primary text-white btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#createCategory"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; Tambah Kategori</button>
                    </div>
                    <div class="card-body">
            ...
            <form action="{{route('management-system.team.category.store')}}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="category_name" value="" id="inputNamaKategori" class="form-control" placeholder="Isi nama kategori" required>
                    </div>
                    <div class="mb-3">
