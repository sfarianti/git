...
@section('content')
                    ...
                    <div class="container-xl px-4 mt-4">
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="row gx-3 mb-3" id="benefitFinancial">
                                    <div class="col-md-5">
                                        <label class="mb-1" for="dataFinancial">Financial (Real)</label>
                                    </div>
                                    <div class="col-md-5">
                                        <input class="form-control" id="dataFinancial" type="text" name="financial" value="" disabled>
                                    </div>
                                </div>
                                <div class="row gx-3 mb-3" id="benefitFinancial">
                                    <div class="col-md-5">
                                        <label class="mb-1" for="dataBenefitPtential">Benefit Potential</label>
                                    </div>
                                    <div class="col-md-5">
                                        <input class="form-control" id="dataBenefitPotential" type="text" name="potential_benefit" value="" disabled>
                                    </div>
                                </div>
...
@push('js')
    ...
    <script>
        ...
        function get_data_benefit(idEvent){
            ...
            // document.getElementById("addBenefitNonFin").setAttribute("onclick", `add_benefit_nonfin(${idEvent})`);
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
