            ...
            <div class="col-lg-12">
                <div class="row">
                        <div class="col-xl-4 mb-4">
                            ...
                            <a class="card h-100 lift border-start-lg border-start-primary" href="{{route('evidence.index')}}">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                                            ...
                                            <div class="text-muted small">
                                                Kumpulan makalah, list kepersetaan, sertifikat, serta dokumen atau informasi pendukung lainnya
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-4 mb-4">
                            ...
                            <a class="card h-100 lift border-start-lg border-start-success" href="{{route('dokumentasi.berita-acara.index')}}">
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                                            ...
                                            <div class="text-muted small">
                                                 Surat berita acara penetapan pememnang yang telah ditandatangani oleh BOD
                        ...
                        <div class="col-xl-4 mb-4">
                            ...
                            <a class="card lift h-100 border-start-lg border-start-secondary" href="{{route('management-system.role.admin.index')}}">
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                                            <i class="feather-lg text-secondary mb-3" data-feather="file-text"></i>
                                            <h5 class="text-secondary">Flyer</h5>
                                            <div class="text-muted small">
                                                Informasi visual kegiatan inovasi
                                            </div>
                                        </div>
                                    </div>
                                </div>
