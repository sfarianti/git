<nav class="nav nav-borders">
    ...
    <a class="nav-link {{ Route::is('assessment.presentation') ? 'active' : '' }}" href="{{route('assessment.presentation')}}">Penilaian Presentasi</a>
    ...
    <a class="nav-link {{ Route::is('assessment.showDeterminingTheBestOfTheBestTeam') ? 'active' : '' }}" href="{{route('assessment.showDeterminingTheBestOfTheBestTeam')}}">Penetapan Akhir</a>
