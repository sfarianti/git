...
<!-- Modal -->
<div class="modal fade" id="ppt" tabindex="-1" role="dialog" aria-labelledby="pptLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe id="pptViewer" src="" width="100%" height="500px"></iframe>
            </div>
        </div>
    </div>
</div> 
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.length > 0) {
                ...
                var pptUrl = '{{ route("query.getFile") }}' + '?directory=' + response[0].file_ppt;

                // Set the URL as the source for the iframe
                document.getElementById("pptViewer").src = pptUrl;
            } else {
                console.error('No data found for team_id:', team_id);
            }
        },
        error: function(xhr, status, error) {
