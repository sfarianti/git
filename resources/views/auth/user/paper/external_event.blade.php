                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="team_name" id="inputTeamName" class="form-control" value="{{$dt_team->team_name}}" readonly>
                                        </div>
                                        @error('team_name')
                                       ...
                                       <div class="mb-2">
                                            ...
                                            <input type="text" name="innovation_title" id="inputInnovationTitle" class="form-control" value="{{$dt_team->innovation_title}}">
                                        </div>
                                        <div class="mb-2" id="div_fasilitator">
                                            <label class="small mb-1" for="id_fasil">Fasilitator</label>

                                            <select class="form-select" aria-label="Default select example"
                                                name="fasilitator" id="id_fasil"
                                                onChange="check_select(this)" required></select>
                                        </div>
                                        <div class="mb-2" id="div_leader">
                                            <label class="small mb-1" for="id_leader">Leader</label>

                                            <select class="form-select" aria-label="Default select example"
                                                name="leader" id="id_leader"
                                                onChange="check_select(this)" required></select>
                                        </div>
                                        <div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="company" id="inputCompany" class="form-control">
                                                ...
                                                @foreach ($datas_company as $opt)
                                                    <option value="{{ $opt->company_code }}" {{ $dt_team->code_company === $opt->company_code ? 'selected' : '' }}>{{ $opt->company_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="phone_number" id="phone_number" class="form-control" value="{{$dt_team->phone_number}}">
                                        </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" name="file_paper" id="inputPaper" accept=" .doc, .docx, .pdf">
                                        </div>
                                        @error('file_paper')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <div class="mb-3">
                                           ...
                                           <input type="file" class="form-control" name="ppt" id="inputPPT" accept=" .mp4, .mov, .avi">
                                        </div>
                                        @error('ppt')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="file" class="form-control" name="video" id="inputVideo" accept=" .ppt, .pptx, .pdf">
                                        </div>
                                        @error('video')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        data_member.forEach(function(member) {
            if(member.status == 'outsource'){
                ...
                search_select2('id_leader', member.employee_id, `${member.employee_id} - ${member.name}`)
            }else if(member.status == 'facilitator'){
                search_select2('id_fasil', member.employee_id, `${member.employee_id} - ${member.name}`)
            }else{
                member_ke++
                search_select2(`id_anggota_${member_ke}`, member.employee_id, `${member.employee_id} - ${member.name}`)
            }
        });
