            ...
            <div class="col-xl-7 col-lg-8 col-md-9 col-sm-11">
                ...
                <div class="card border-0 shadow-lg mt-5 mb-5">
                        ...
                        <div class="card-body p-5">
                            ...
                            <form action="{{ route('paper.register.store') }}" method="POST"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control form-control-solid" name="innovation_title"
                                        value="{{ $dt_team['innovation_title'] }}" id="inputInnovationTitle"
                                        type="text" placeholder="Masukkan Judul Inovasi Tim Anda" required />
                                </div>
                                <div class="mb-4">
                                    <h6 class="small mb-1" for="inputLokasiInvovasi">Lokasi Implementasi Inovasi</h6>
                                    <input class="form-control" name="inovasi_lokasi"
                                        value="{{ old('inovasi_lokasi') }}" id="inovasi_lokasi"
                                        type="text" placeholder="Masukkan Lokasi Implementasi Inovasi Tim Anda" required />
                                </div>
                                <!-- class="form-select form-control-solid" -->
                                <div class="mb-4">
                                    <h6 class="small mb-1">Kategori</h6>
                                    <select class="form-select" aria-label="Default select example"
                                        name="category" id="id_category" value="{{ old('category') }}"
                                        placeholder="Pilih Kategori Inovasi Anda" onChange="addRow(this)"
                                        required>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" aria-label="Default select example"
                                        name="status_lomba" id="chooseEvent" value="{{ old('event') }}"
                                        placeholder="Pilih Kategori Inovasi Anda" onChange="changeStatusLomba(this)"
                                        required>    
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" aria-label="Default select example"
                                        name="fasil" id="id_fasil" value="{{ old('fasil') }}"
                                        placeholder="Pilih Fasilitator" onChange="check_select(this)" required>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" aria-label="Default select example"
                                        name="leader" id="id_leader" value="{{ old('leader') }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control form-control-solid" name="company" id="company"
                                        ...
                                        placeholder="Pilih Nama Perusahaan Anda" readonly required />
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example"
                                        name="theme" id="id_theme" value="{{ old('theme') }}" required>
                ...
                setTimeout(function() {
                    ...
                    data_member.forEach(function(member) {
                        if(member.status == 'outsource'){
                            ...
                            selected_select2('id_leader', member.employee_id, `${member.employee_id} - ${member.name}`)
                        }else if(member.status == 'facilitator'){
                            selected_select2('id_fasil', member.employee_id, `${member.employee_id} - ${member.name}`)
                        }else{
                            member_ke++
                            selected_select2(`id_anggota_${member_ke}`, member.employee_id, `${member.employee_id} - ${member.name}`)
                        }
